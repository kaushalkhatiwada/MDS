import logging
from extract import extract  # Import the extract function from extract.py
from transform import transform  # Import the transform function from transform.py
from load import load_to_mongodb  # Import the load function from load.py
