...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetC` ()  BEGIN
    SELECT 
        customerName, 
        city, 
        state, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetEmp` ()  BEGIN
    SELECT 
        firstName, 
        lastName, 
        city, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetOrderCountByStatus` (IN `orderStatus` VARCHAR(25), OUT `total` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetTO` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetTotalOrder` ()  BEGIN
...
(3, 'Ram', 'john.doe@example.com', NULL),
(4, 'Ram', 'jane.doe@example.com', '2000-01-01');
...
(2, 3, 'Hi Ram, please update your date of birth.');
...
--
DELIMITER $$
CREATE TRIGGER `after_salaries_delete` AFTER DELETE ON `salaries` FOR EACH ROW UPDATE SalaryBudgets 
SET total = total - old.amount
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `before_salaries_delete` BEFORE DELETE ON `salaries` FOR EACH ROW BEGIN
...
--
-- Table structure for table `salaryarchives`
--
...
--
-- Dumping data for table `salaryarchives`
--

INSERT INTO `salaryarchives` (`id`, `employeeNumber`, `validFrom`, `amount`, `deletedAt`) VALUES
(1, 1002, '2000-01-01', '50000.00', '2021-03-31 14:29:31'),
(2, 1056, '2000-01-01', '60000.00', '2021-03-31 14:31:18'),
(3, 1076, '2000-01-01', '70000.00', '2021-03-31 14:31:18'),
(4, 10002, '0000-00-00', '5000.00', '2021-03-31 14:45:10'),
(5, 10056, '0000-00-00', '7000.00', '2021-03-31 14:45:45'),
(6, 10076, '0000-00-00', '8000.00', '2021-03-31 14:45:45'),
(7, 1002, '2000-01-01', '50000.00', '2021-03-31 14:51:20'),
(8, 1056, '2000-01-01', '60000.00', '2021-03-31 14:56:19'),
(9, 1076, '2000-01-01', '70000.00', '2021-03-31 14:56:23'),
(10, 10002, '0000-00-00', '5000.00', '2021-03-31 14:59:00'),
(11, 10056, '0000-00-00', '7000.00', '2021-03-31 14:59:48'),
(12, 10076, '0000-00-00', '8000.00', '2021-03-31 14:59:48');

-- --------------------------------------------------------

--
-- Table structure for table `salarybudgets`
--
...
--
-- Dumping data for table `salarybudgets`
--
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `workcenters_insert_before` BEFORE INSERT ON `workcenters` FOR EACH ROW BEGIN
    DECLARE rowcount INT;
...
--
-- Indexes for table `salaryarchives`
--
...
--
-- AUTO_INCREMENT for table `salaryarchives`
--
ALTER TABLE `salaryarchives`
